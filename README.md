...
| Docker Registry                     | [Docker Registry](https://docs.docker.com/registry/) <br /> [Joxit Docker Registry UI](https://joxit.dev/docker-registry-ui/) | [Apache-2.0](https://github.com/docker/distribution/blob/master/LICENSE)  <br /> [AGPL-3.0](https://github.com/Joxit/docker-registry-ui/blob/master/LICENSE) |
