...
sed -i 's|@DRONE_HTTP_PORT$|'"$DRONE_HTTP_PORT"'|g' $CI_ENV
sed -i 's|@DRONE_VAULT_PLUGIN_PORT$|'"$DRONE_VAULT_PLUGIN_PORT"'|g' $CI_ENV
sed -i 's|@DRONE_POSTGRESQL_PORT$|'"$DRONE_POSTGRESQL_PORT"'|g' $CI_ENV
