...
TAIGA_POSTGRESQL_DATA=$TAIGA_DATA/db
TAIGA_PROXY_CONF=$TAIGA_DATA/proxy

TAIGA_POSTGRES_PORT=${PROJECT_PORTS_PREFIX}32
...
find $TAIGA_SRC -type f -name '*.env' -exec sed -i -e 's|@TAIGA_BACK_MEDIA|'"$TAIGA_BACK_MEDIA"'|g' {} \;
find $TAIGA_SRC -type f -name '*.env' -exec sed -i -e 's|@TAIGA_BACK_CONF|'"$TAIGA_BACK_CONF"'|g' {} \;
find $TAIGA_SRC -type f -name '*.env' -exec sed -i -e 's|@TAIGA_FRONT_CONF|'"$TAIGA_FRONT_CONF"'|g' {} \;
find $TAIGA_SRC -type f -name '*.env' -exec sed -i -e 's|@TAIGA_POSTGRESQL_DATA|'"$TAIGA_POSTGRESQL_DATA"'|g' {} \;
find $TAIGA_SRC -type f -name '*.env' -exec sed -i -e 's|@TAIGA_PROXY_CONF|'"$TAIGA_PROXY_CONF"'|g' {} \;
