...
REGISTRY_SRC=$(dirname $(realpath $0))
...
LOCALHOST="127.0.0.1"
REGISTRY_PORT_BINDING="$LOCALHOST:$REGISTRY_PORT"
REGISTRY_UI_PORT_BINDING="$LOCALHOST:$REGISTRY_UI_PORT"
...
sed -i 's|@REGISTRY_PORT_BINDING$|'"$REGISTRY_PORT_BINDING"'|g' $REGISTRY_ENV
sed -i 's|@REGISTRY_UI_PORT_BINDING$|'"$REGISTRY_UI_PORT_BINDING"'|g' $REGISTRY_ENV
sed -i 's|@YOUR_DOMAIN$|'"$YOUR_DOMAIN"'|g' $REGISTRY_ENV
